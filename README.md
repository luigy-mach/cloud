...
[![DockerPulls](https://img.shields.io/docker/pulls/luigymach/hadoop-spark-cluster.svg)](https://registry.hub.docker.com/u/luigymach/hadoop-spark-cluster/) [![DockerStars](https://img.shields.io/docker/stars/luigymach/hadoop-spark-cluster.svg)](https://registry.hub.docker.com/u/luigymach/hadoop-spark-cluster/)
...
### Crear una red
- Crear **hadoop-overlay**
```console
foo@bar:~$ sudo docker network create --driver overlay --attachable --subnet=20.0.9.0/24 hadoop-overlay
